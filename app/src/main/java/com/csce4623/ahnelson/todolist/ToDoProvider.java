...
public class ToDoProvider extends ContentProvider {
    ...
    public static final String TODO_TABLE_COL_DUEDATE = "DUEDATE";
...
//  Cursor myCursor = getContentResolver().query(ToDoProvider.CONTENT_URI,projection,null,null,null);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int updateCount = mOpenHelper.getWritableDatabase().update(TABLE_NAME,values, selection,selectionArgs);
        //        getContentResolver().update(ToDoProvider.CONTENT_URI, myCV,ToDoProvider.TODO_TABLE_COL_ID+"=?", new String[] {loadedTOdoID} );
        //Notify the context
        getContext().getContentResolver().notifyChange(uri,null);
